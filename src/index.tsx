      ...
      <div class="services-grid stagger-children">
        ...
        <div class="service-card reveal">
          ...
          <div class="service-tags">
            ...
            <span class="service-tag">UX Writing</span>
          </div>
        </div>
        <div class="service-card reveal">
          <div class="service-icon">
      ...
      <div class="contact-grid">
        <div class="contact-info reveal-left">
          ...
          <div class="contact-social">
            <a href="https://www.linkedin.com/in/katlynbrown96/" target="_blank" class="social-link" aria-label="LinkedIn">
              <svg viewBox="0 0 24 24"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
            </a>
            <a href="mailto:katyrbrown96@gmail.com" class="social-link" aria-label="Email">
              <svg viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
            </a>
          </div>
        </div>
    ...
    <div class="container">
      <div class="footer-inner">
        ...
        <div class="footer-links">
          ...
          <a href="https://www.linkedin.com/in/katlynbrown96/" target="_blank">LinkedIn</a>
